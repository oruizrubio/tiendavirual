...
<?php
	...
	if ($_SESSION['insertado'] == "S") {
		  echo '<div class="alert alert-success">  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>¡Atención!</strong> Se ha insertado el producto con éxito.</div>';
		  $_SESSION["insertado"] = "N";
    }
	
	if ($_SESSION['borrado'] == "S") {
		  echo '<div class="alert alert-success">  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>¡Atención!</strong> Se ha borrado el producto con éxito.</div>';
		  $_SESSION["borrado"] = "N";
    }	

	if ($_SESSION['actualizado'] == "S") {
		  echo '<div class="alert alert-success">  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>¡Atención!</strong> Se ha actualizado el producto con éxito.</div>';
		  $_SESSION["actualizado"] = "N";
    }	
	...
	if (isset($_SESSION['k_username'])) {
		...
		echo "<tr>
			<td>$row[0]</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td><center><a href=\"actualizar_producto.php?codigo=$row[0]\"><image src=\"imagenes/edit.png\" alt=\"Actualizar\" title=\"Actualizar\"/></a><a href=\"borrar_producto.php?codigo=$row[0]\">&nbsp;&nbsp;<image src=\"imagenes/delete.png\" alt=\"Borrar\" title=\"Borrar\"/></center></a></td>
			</tr>";
		}	
		echo "</tbody></table>";
		if ($result==0) {
        ...
        echo "</p><p><a href=\"insertar_producto.php\" class=\"btn btn-primary btn-large\">Crear artículo</a></p>";		
	}
	else {
